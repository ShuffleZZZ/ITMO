...
public class UserRepositoryImpl implements UserRepository {
        ...
        return (User) DatabaseUtils.performRequest(
                ...
                (PreparedStatement statement) -> {
                    try (ResultSet resultSet = statement.executeQuery()) {
                        ...
                        throw new RepositoryException("Unable to find User.", e);
                    }
                    return null;
                }, args);
        ...
        DatabaseUtils.performRequest(
                ...
                (PreparedStatement statement) -> {
                    try (ResultSet result = statement.executeQuery()) {
                        ...
                        throw new RepositoryException("Unable to find all Users.", e);
                    }
                    return null;
                });
        return users;
    ...
    public void save(User user, String passwordSha) {
        User outUser = (User) DatabaseUtils.performRequest(
            ...
            try {
                if (statement.executeUpdate() == 1) {
                    ...
                    if (generatedIdResultSet.next()) {
                        returnUser = findByEmail(user.getEmail());
                    }
                }
            } catch (SQLException e) {
                throw new RepositoryException("Unable to save User.", e);
            }
            if (returnUser == null) {
        ...
        }, user.getLogin(), passwordSha, user.getEmail());
        emailConfirmationService.emailToConfirm(outUser);
    }
}
